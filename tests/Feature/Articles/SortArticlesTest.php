...
class SortArticlesTest extends TestCase
{
    ...
    public function can_sort_articles_by_content_descending()
    {
        ...
        $this->getJson($url)
            ->assertSeeInOrder(['C content', 'B content', 'A content']);
    }

    /** @test */
    public function can_sort_articles_by_title_and_content_desc()
    {
    ...
    /** @test */
    public function cannot_sort_articles_by_unknown_field()
    {
        Article::factory()->count(3)->create();

        //  /articles?sort=unknow
